...
setwd("Z:/Biobank_Vascular/Windows/Gorilla_Mark_1123/shortform_unblind_wex")
...
setwd("Z:/Biobank_Vascular/Windows/Gorilla_Mark_1123/Clean_WEX_data_1123")

#exporting tables
#"-_ps" = full data downloaded from gorilla
write.csv(visual_ps, file = "visual_ps_full_data.csv")
write.csv(semantic_ps, file = "semantic_ps_full_data.csv")
write.csv(motor_ps, file = "motor_ps_full_data.csv")
write.csv(basic_rt, file = "basic_rt_full_data.csv")
...
write.csv(visual_exp, file = "visual_clean_trials.csv")
write.csv(semantic_exp, file = "semantic_clean_trials.csv")
write.csv(motor_exp, file = "motor_clean_trials.csv")
write.csv(basic_rt_exp, file = "basic_rt_clean_trials.csv")

#"-_sums" = one participant per row, contains trial averages and totals for each ppt. 
write.csv(visual_sums, file = "visual_ppt_avgs.csv")
write.csv(semantic_sums, file = "semantic_ppt_avgs.csv")
write.csv(motor_sums, file = "motor_ppt_avgs.csv")
write.csv(basic_rt_sums, file = "basic_rt_ppt_avgs.csv")
